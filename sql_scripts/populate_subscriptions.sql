INSERT INTO subscriptions_details (
    ...
    ('small_monthly',            'monthly',     900,  800,   30,     TRUE, 1, 50,  50),
    ...
    ('models_small_pack',        'models',      1600,  1400,  NULL,  TRUE, 2, 0, 0),
    ('models_small_pack',        'models',      3600,  3190,  NULL,  TRUE, 5, 0, 0),

    ('generations_small_pack',  'generations',  400,   250,   NULL,   TRUE, 0, 50,   50);
    ('generations_midle_pack',  'generations',  1000,  880,   NULL,   TRUE, 0, 150,  150);
